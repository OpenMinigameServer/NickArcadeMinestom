...
public class SpongeSchematic implements ISchematic {
    ...
    // https://github.com/EngineHub/WorldEdit/blob/303f5a76b2df70d63480f2126c9ef4b228eb3c59/worldedit-core/src/main
    // /java/com/sk89q/worldedit/extent/clipboard/io/SpongeSchematicReader.java#L261-L297
    ...
    private ErrorMessage writeBlockPalette(NBTCompound nbtTag, Region region) {
        ...
        ByteArrayOutputStream buffer =
                new ByteArrayOutputStream(region.getSizeX() * region.getSizeY() * region.getSizeZ());
    ...
    public ErrorMessage build(@NotNull Position position) {
        ...
        for (Region.RegionBlock regionBlock : this.regionBlocks) {
            ...
            this.blockBatch.setBlockStateId(blockPosition.getX() + (int) position.getX(),
                    blockPosition.getY() + (int) position.getY(), blockPosition.getZ() + (int) position.getZ(),
                    stateId);
        }
