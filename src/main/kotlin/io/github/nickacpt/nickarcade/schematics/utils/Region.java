package io.github.nickacpt.nickarcade.schematics.utils;
...
public class Region implements Iterable<Region.RegionBlock>, Cloneable {
    ...
    public Region(BlockPosition position1, BlockPosition position2) {
        this.pos1 = new BlockPosition(Math.min(position1.getX(), position2.getX()), Math.min(position1.getY(),
                position2.getY()), Math.min(position1.getZ(), position2.getZ()));
        this.pos2 = new BlockPosition(Math.max(position1.getX(), position2.getX()), Math.max(position1.getY(),
                position2.getY()), Math.max(position1.getZ(), position2.getZ()));
    ...
    public Iterator<RegionBlock> iterator() {
        return new RegionIterator(this.pos1.getX(), this.pos1.getY(), pos1.getZ(), this.pos2.getX(), pos2.getY(),
                pos2.getZ(), this.instance);
    }
    ...
    public class RegionIterator implements Iterator<RegionBlock> {
        ...
        public RegionBlock next() {
            BlockPosition blockPosition = new BlockPosition(this.baseX + this.x, this.baseY + this.y,
                    this.baseZ + this.z);
