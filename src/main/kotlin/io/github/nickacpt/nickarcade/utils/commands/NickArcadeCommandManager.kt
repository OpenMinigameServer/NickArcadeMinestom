...
class NickArcadeCommandManager(private val plugin: JavaPlugin) {
    ...
    fun init(): NickArcadeCommandManager? {
        val executionCoordinatorFunction =
            CommandExecutionCoordinator.simpleCoordinator<CommandSender>()
        try {
